...
const ArrayList = (props: IFormComponentProps<any>) => {
  ...
  const { push: add, remove: remove, moveUp, moveDown, getEmptyValue } = mutators;
  ...
  return (
    <div>
      ...
      <div onClick={() => add(getEmptyValue((children as React.ReactElement).props))} style={{ fontWeight: 'bold' }}>
        +新增一行
      </div>
    </div>
  );
